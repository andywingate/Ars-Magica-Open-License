# Aldric of Mercere — Character Sheet

*Ars Magica 5th Edition · Hermetic Magus · House Mercere (Gifted)*
...
| **Warping** | Score 0 |
| **Decrepitude** | 0 |
| **Sigil** | A faint warmth, like the first light of morning, suffusing anything his magic touches |
...
| Improved Characteristics | General, Minor | 1 | +3 Characteristic points |
| Puissant Single Weapon | General, Minor | 1 | +2 to Single Weapon totals |

### Flaws — 10 points

| Flaw | Type | Cost | Effect |
|---|---|---:|---|
| Deficient Technique — Perdo | Hermetic, Major | 3 | Every Perdo total, Lab and Casting alike, is halved |
| Driven — to bring every man he leads home alive | Personality, Major | 3 | A goal big enough to shape a life, and one he can never finish |
| Favors — House Mercere | Story, Major | 3 | The House calls in its debts, usually at the worst possible moment |
...
Thirteen points: seven base plus three each from Improved Characteristics taken twice. Large
...
**A cell is a Casting Score, not a finished roll.** It is the fixed part; dice and situational
modifiers go on top.

> **Casting Score = Technique + Form + Stamina − Encumbrance + Aura Modifier**
>
> **Formulaic Casting Total = Casting Score + die** — a simple die when relaxed, a stress die under pressure

Compare that total to the spell's level:

| Casting Total − Spell Level | Spell cast? | Fatigue lost |
|---|---|---|
| 0 or higher | Yes | none |
| −1 to −10 | Yes | one level |
| −11 or lower | No | one level |

### Modifiers to apply to a cell
...
> **Fatiguing: (Casting Score + stress die) ÷ 2** · **Non-fatiguing: Casting Score ÷ 5**

Both round down. Out of armour, no aura:
...
**Wounds at Size +1:** Light 1–6 (−1) · Medium 7–12 (−3) · Heavy 13–18 (−5) · Incapacitating 19–24 · Dead 25+

Penalties are cumulative with Fatigue and apply to every action — **but never to Soak**.
...
|---|---:|
| Brave | +3 |
| Driven to bring them all home | +3 *(Flaw)* |
| Overconfident | +2 *(Flaw)* |
| Scholarly interest in the body | +2 |

No Reputation at the start of play.

---

## Appendix — Build audit
