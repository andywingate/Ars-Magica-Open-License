...
What to cast, what to swing at, and in what order — with every number derived from the rule that
produces it. Assumes the sheet in `character-sheet.md`.

---

## Fight card

**Field conditions: full harness (Encumbrance 2), no aura.**
